            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
                        <div id="image-preview" class="{{ $category->image_url ? '' : 'hidden' }} mb-4">
                            <img id="preview-img" src="{{ $category->image_url ? asset('images/category_images/' . $category->image_url) : '' }}" alt="Preview" class="mx-auto h-32 w-32 object-cover rounded-lg">
                        </div>
                        
                        <div id="upload-placeholder" class="{{ $category->image_url ? 'hidden' : '' }}">
                        ...
                        <button type="button" onclick="document.getElementById('image').click()" 
                            ...
                            {{ $category->image_url ? 'Change Image' : 'Choose Image' }}
                        </button>
